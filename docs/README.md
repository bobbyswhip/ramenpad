...
- [Scalable live indexing](SCALABLE_INDEXING_ARCHITECTURE.md) — WebSocket-first ingestion, durable replay, dynamic pool subscriptions, readiness, costs, and rollout.
