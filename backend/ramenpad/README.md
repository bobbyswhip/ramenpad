...
Socket events are `ramenpad:launch`, `ramenpad:trade`, `ramenpad:tokens:update`, and `ramenpad:fees`.
...
- A production `DATABASE_URL` and provider RPC/WebSocket endpoint.
